...
namespace EasyStory.API.Services
{
    public class UserService : IUserService
    {
        ...
        public UserService(IUserRepository userRepository, IBookmarkRepository bookmarkRepository, IUnitOfWork unitOfWork, ISubscriptionRepository subscriptionRepository)
        {
