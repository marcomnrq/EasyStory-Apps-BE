...
Given I am a client
When I make a post request to 'api/users' with the following data '{ "Username" : "gonchox08", "Email" : "gonchoo@.com", "Password" : "easysstoryy", "FirstName" : "Gonzalo", "LastName" : "nosexdxd"}'
